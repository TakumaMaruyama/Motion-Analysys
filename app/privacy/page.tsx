  ...
  return (
    ...
    >
      <LegalSection id="local-processing" title="1. 映像は端末内で処理します">
        <p>
          利用者が端末から明示的に選択したスタート動画、姿勢ランドマーク、イベント候補、校正値、分析結果は、利用中のブラウザ内で処理します。本アプリには、動画または分析結果を運営者のサーバーへアップロードする機能はありません。無料ベータ版はライブカメラ入力を使用しません。
        </p>
        <p>
      ...
      <LegalSection id="data" title="2. 本アプリが扱う情報">
        <ul>
          ...
          <li>
            <strong>分析結果：</strong>
            姿勢ランドマーク、確認済みスタートイベント、時間、2D距離・速度・角度、研究参考帯、品質情報、修正履歴を現在のセッション内で生成します。
          </li>
          <li>
